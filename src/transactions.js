...
exports.sendSignedTransaction = exports.sendTransactionPhantom = exports.sendTransactionWithRetryWithKeypair = void 0;
...
var sendTransactionPhantom = function (connection, solana, instructions, commitment, includesFeePayer, block, beforeSend) {
    if (commitment === void 0) { commitment = 'singleGossip'; }
    if (includesFeePayer === void 0) { includesFeePayer = false; }
    return __awaiter(void 0, void 0, void 0, function () {
        var transaction, _a, _b, signed, _c, txid, slot;
        return __generator(this, function (_d) {
            switch (_d.label) {
                case 0:
                    transaction = new web3_js_1.Transaction();
                ...
                case 2:
                    ...
                    return [4 /*yield*/, solana.signTransaction(transaction)];
                case 3:
                    signed = _d.sent();
                    if (beforeSend) {
                        beforeSend();
...
exports.sendTransactionPhantom = sendTransactionPhantom;
